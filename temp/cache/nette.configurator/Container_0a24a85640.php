<?php
// source: D:\Data\ITnetwork\PHP\Nette\nette-check\sandbox/config/common.neon
// source: D:\Data\ITnetwork\PHP\Nette\nette-check\sandbox/config/local.neon
// source: array
...
class Container_0a24a85640 extends Nette\DI\Container
{
	protected $tags = [
		'nette.inject' => [
			'application.1' => true,
	...
	public function __construct(array $params = [])
	{
		...
		$this->parameters += [
			'appDir' => 'D:\Data\ITnetwork\PHP\Nette\nette-check\sandbox\app',
			'wwwDir' => 'D:\Data\ITnetwork\PHP\Nette\nette-check\sandbox\www',
			'vendorDir' => 'D:\Data\ITnetwork\PHP\Nette\nette-check\sandbox\vendor',
			'debugMode' => true,
			'productionMode' => false,
			'consoleMode' => false,
			'tempDir' => 'D:\Data\ITnetwork\PHP\Nette\nette-check\sandbox/temp',
		];
	}
	...
	public function createServiceApplication__presenterFactory(): Nette\Application\IPresenterFactory
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback(
			$this,
			5,
			'D:\Data\ITnetwork\PHP\Nette\nette-check\sandbox/temp/cache/nette.application/touch'
		));
	...
	{
		return new Nette\Caching\Storages\SQLiteJournal('D:\Data\ITnetwork\PHP\Nette\nette-check\sandbox/temp/cache/journal.s3db');
	}
	...
	public function createServiceCache__storage(): Nette\Caching\Storage
	{
		return new Nette\Caching\Storages\FileStorage(
			'D:\Data\ITnetwork\PHP\Nette\nette-check\sandbox/temp/cache',
			$this->getService('cache.journal')
		);
	}


	public function createServiceContainer(): Container_0a24a85640
	{
		return $this;
	}
	...
	public function createServiceLatte__latteFactory(): Nette\Bridges\ApplicationLatte\LatteFactory
	{
		return new class ($this) implements Nette\Bridges\ApplicationLatte\LatteFactory {
			...
			public function __construct(Container_0a24a85640 $container)
			{
			...
			public function create(): Latte\Engine
			{
				...
				$service->setTempDirectory('D:\Data\ITnetwork\PHP\Nette\nette-check\sandbox/temp/cache/latte');
