...
INSERT INTO `iis_vyrobna` (`id`, `id_vyrobniho_zdroje`, `id_site`, `id_firmy`, `kratky_nazev`, `ulice`, `cislo_p`, `cislo_o`, `kraj`, `okres`, `obec`, `psc`, `parcela`, `gps_n`, `gps_e`, `druh_vyrobny`,`stav`, `vyrobni_EAN`, `EAN_vyrobny`, `vykon_zdroje`, `napetova_hladina`, `zpusob_pripojeni`, `vykaz_za_opm`, `druh_podpory`, `datum_prvniho_pripojeni`, `datum_uvedeni_do_provozu`) VALUES(2, 2, 2, 123456789,'Výrobna 2', 'Modrá', '1024', '8', 'Olomoucký kraj', 'Olomouc', 'Olomouc', 77900, '235/16', '18.45899', '27.00530', 'slunecni', 'schvaleno', 1001, 2002, 35, '110', 'primo', 'ano', 'bonus_rocni', '2021-09-04', '2021-09-08');
